...
class ConstantMethods {
    ...
    return ElevatedButton(
      ...
      child: Text(
        ...
        style: TextStyle(
            color: bgcolor,
            fontSize: 15,
            fontFamily: ConstantVariable.MuktaBold),
      ),
  ...
  static Widget custombutton2(double tvSize, Color tvColor, String text,
      Color buttonColor, double buttonCorner, String tvFont) {
    return ElevatedButton(
      onPressed: () {},
      child: Text(
        text,
        style: TextStyle(color: tvColor, fontSize: tvSize, fontFamily: tvFont),
      ),
      style: ElevatedButton.styleFrom(
          primary: buttonColor,
          shape: RoundedRectangleBorder(
...
//   static Object returnSelectedPageFromBottomNavigation(
...
//           .push(MaterialPageRoute(builder: (context) => ForumsStudentScreen()));
//     } else if (position == 4) {
...
//     return const TextStyle(fontSize: 15.0, height: 0.6, color: Colors.black);
//   }
